 ...
 * </p>
 * >
 * ere are then 3 methods available for interacting with the connection:
 * <ol>
...
public class c {
    ...
    public static class Flip {
        ...
        public Flip(String[] cols, Object[] values) {
            x = (String[]) cols;
            y = (Object[]) values;
        }
...
//object.getClass().isArray()   t(int[]) is .5 isarray is .1 lookup .05
    ...
    protected void w(int msgType, Object x) throws IOException {
        synchronized (o) {
            ...
            writeSocket(buffer, 0, buffer.length);
        }
    }

    public void writeSocket(byte[] buffer, int offset , int length) throws IOException {
